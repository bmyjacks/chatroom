...
class ClientHandler implements Runnable {
     ...
     * If the username is "/exit", the system will exit.
     *
    ...
    /**
     * Processes a message from the client and add to the Server's history
     * If the message is "/exit", the client will be set to offline.
     *
     ...
     * It gets the username input, sends the chat history, and processes messages from the client until they go offline.
     */
    @Override
    public void run() {
        getUsernameInput();
