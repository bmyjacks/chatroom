 ...
 * It uses the picocli library to parse command line arguments.
 * The application can be run as a server or a client.
 */
...
public class Main {
     ...
     * It parses the command line arguments and runs the application as a server or client based on the arguments.
     *
